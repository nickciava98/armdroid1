...
{
  //011
  digitalWrite(selMotoreC4, LOW); 
  digitalWrite(selMotoreC3, HIGH); 
  digitalWrite(selMotoreC2, HIGH);
}

void motoreSpallaOn()
{
  //101
  digitalWrite(selMotoreC4, HIGH); 
  digitalWrite(selMotoreC3, LOW); 
  digitalWrite(selMotoreC2, HIGH);
}
...
void motoreAvanti(byte v, byte swBa, byte swS, byte swBr, byte swP1, byte swP2, byte swM)
{
  ...
  //avanti 1100 - 1001 - 0011 - 0110 rispettivamente faseC8faseC6faseC5faseC4
  digitalWrite(faseC8, HIGH); 
  digitalWrite(faseC7, HIGH); 
  digitalWrite(faseC6, LOW); 
  digitalWrite(faseC5, LOW);
  ...
  digitalWrite(faseC8, HIGH); 
  digitalWrite(faseC7, LOW); 
  digitalWrite(faseC6, LOW); 
  digitalWrite(faseC5, HIGH);
  ...
  digitalWrite(faseC8, LOW); 
  digitalWrite(faseC7, LOW); 
  digitalWrite(faseC6, HIGH); 
  digitalWrite(faseC5, HIGH);
